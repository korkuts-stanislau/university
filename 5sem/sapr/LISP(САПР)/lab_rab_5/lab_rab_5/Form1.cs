...
namespace lab_rab_5
{
    public partial class Form1 : Form
    {
        ...
        UInt32 LFSR()
        {
            a = ((((a >> 31) ^ (a >> 29) ^ (a >> 27) ^ (a >> 26) ^ (a >> 24) ^ (a >> 23) ^ (a >> 22) ^ (a >> 20) ^ (a >> 19) ^ (a >> 18) ^ (a >> 17) ^ (a >> 15) ^ (a >> 14) ^ (a >> 13) ^ (a >> 7) ^ (a >> 5) ^ (a >> 4) ^ (a >> 2) ^ a) & 0x00000001) << 31) | (a >> 2);
            return a;
        }
        private void button1_Click(object sender, EventArgs e)
        {
            textBoxResult.Text = "";
            double zatr_cont = 3; //B
            double zatr_o1 = 55;//C
            double zatr_o2 = 145;//D
            double primes = 0.05 * UInt32.MaxValue;//A
            double p, sum_zatr;
            int proc = 0;
