...
namespace DataModel
{
	...
	public partial class StockDB : LinqToDB.Data.DataConnection
	{
		...
		public ITable<ExpenditureInvoice> ExpenditureInvoices { get { return this.GetTable<ExpenditureInvoice>(); } }
		public ITable<Product>            Products            { get { return this.GetTable<Product>(); } }
		public ITable<ReceiptInvoice>     ReceiptInvoices     { get { return this.GetTable<ReceiptInvoice>(); } }
	...
	{
		[Column("customer_id"),   PrimaryKey,  Identity] public int    CustomerId   { get; set; } // integer
		[Column("customer_name"), NotNull              ] public string CustomerName { get; set; } // character varying(40)
		[Column("description"),      Nullable          ] public string Description  { get; set; } // character varying(250)

		#region Associations

		/// <summary>
		/// expenditure_invoices_customer_id_fkey_BackReference
		/// </summary>
		...
		public IEnumerable<ExpenditureInvoice> Expenditureinvoicescustomeridfkeys { get; set; }

		/// <summary>
		/// receipt_invoices_customer_id_fkey_BackReference
		/// </summary>
		[Association(ThisKey="CustomerId", OtherKey="CustomerId", CanBeNull=true, Relationship=Relationship.OneToMany, IsBackReference=true)]
		public IEnumerable<ReceiptInvoice> Receiptinvoicescustomeridfkeys { get; set; }

		#endregion
	}

	[Table(Schema="public", Name="expenditure_invoices")]
	public partial class ExpenditureInvoice
	{
		[Column("expenditure_invoice_id"),   PrimaryKey, Identity] public int         ExpenditureInvoiceId   { get; set; } // integer
		[Column("expenditure_invoice_date"), Nullable            ] public NpgsqlDate? ExpenditureInvoiceDate { get; set; } // date
		[Column("customer_id"),              Nullable            ] public int?        CustomerId             { get; set; } // integer
		[Column("stock_id"),                 Nullable            ] public int?        StockId                { get; set; } // integer
		[Column("product_id"),               Nullable            ] public int?        ProductId              { get; set; } // integer
		[Column("count_product"),            Nullable            ] public float?      CountProduct           { get; set; } // real
		[Column("price_product"),            Nullable            ] public float?      PriceProduct           { get; set; } // real

		#region Associations

		/// <summary>
		/// expenditure_invoices_customer_id_fkey
		/// </summary>
		[Association(ThisKey="CustomerId", OtherKey="CustomerId", CanBeNull=true, Relationship=Relationship.ManyToOne, KeyName="expenditure_invoices_customer_id_fkey", BackReferenceName="Expenditureinvoicescustomeridfkeys")]
		public Customer Customer { get; set; }

		/// <summary>
		/// expenditure_invoices_product_id_fkey
		/// </summary>
		[Association(ThisKey="ProductId", OtherKey="ProductId", CanBeNull=true, Relationship=Relationship.ManyToOne, KeyName="expenditure_invoices_product_id_fkey", BackReferenceName="Expenditureinvoicesproductidfkeys")]
		public Product Product { get; set; }

		/// <summary>
		/// expenditure_invoices_stock_id_fkey
		/// </summary>
		[Association(ThisKey="StockId", OtherKey="StockId", CanBeNull=true, Relationship=Relationship.ManyToOne, KeyName="expenditure_invoices_stock_id_fkey", BackReferenceName="Expenditureinvoicesstockidfkeys")]
	...
	{
		[Column("product_id"),   PrimaryKey, Identity] public int    ProductId   { get; set; } // integer
		[Column("product_name"), NotNull             ] public string ProductName { get; set; } // character varying(40)

		#region Associations

		/// <summary>
		/// expenditure_invoices_product_id_fkey_BackReference
		/// </summary>
		[Association(ThisKey="ProductId", OtherKey="ProductId", CanBeNull=true, Relationship=Relationship.OneToMany, IsBackReference=true)]
		public IEnumerable<ExpenditureInvoice> Expenditureinvoicesproductidfkeys { get; set; }

		/// <summary>
		/// receipt_invoices_product_id_fkey_BackReference
		/// </summary>
		[Association(ThisKey="ProductId", OtherKey="ProductId", CanBeNull=true, Relationship=Relationship.OneToMany, IsBackReference=true)]
		public IEnumerable<ReceiptInvoice> Receiptinvoicesproductidfkeys { get; set; }

		#endregion
	}

	[Table(Schema="public", Name="receipt_invoices")]
	public partial class ReceiptInvoice
	{
		[Column("receipt_invoice_id"),   PrimaryKey, Identity] public int         ReceiptInvoiceId   { get; set; } // integer
		[Column("receipt_invoice_date"), Nullable            ] public NpgsqlDate? ReceiptInvoiceDate { get; set; } // date
		[Column("customer_id"),          Nullable            ] public int?        CustomerId         { get; set; } // integer
		[Column("stock_id"),             Nullable            ] public int?        StockId            { get; set; } // integer
		[Column("product_id"),           Nullable            ] public int?        ProductId          { get; set; } // integer
		[Column("count_product"),        Nullable            ] public float?      CountProduct       { get; set; } // real
		...
		/// <summary>
		/// receipt_invoices_customer_id_fkey
		/// </summary>
		[Association(ThisKey="CustomerId", OtherKey="CustomerId", CanBeNull=true, Relationship=Relationship.ManyToOne, KeyName="receipt_invoices_customer_id_fkey", BackReferenceName="Receiptinvoicescustomeridfkeys")]
		public Customer Customer { get; set; }

		/// <summary>
		/// receipt_invoices_product_id_fkey
		/// </summary>
		[Association(ThisKey="ProductId", OtherKey="ProductId", CanBeNull=true, Relationship=Relationship.ManyToOne, KeyName="receipt_invoices_product_id_fkey", BackReferenceName="Receiptinvoicesproductidfkeys")]
		public Product Product { get; set; }

		/// <summary>
		/// receipt_invoices_stock_id_fkey
		/// </summary>
		[Association(ThisKey="StockId", OtherKey="StockId", CanBeNull=true, Relationship=Relationship.ManyToOne, KeyName="receipt_invoices_stock_id_fkey", BackReferenceName="Receiptinvoicesstockidfkeys")]
		public Stock Stock { get; set; }
	...
	{
		[Column("role_name"),             NotNull] public string RoleName { get; set; } // character varying(40)
		[Column("role_key"),  PrimaryKey, NotNull] public string RoleKey  { get; set; } // character varying(15)

		#region Associations

		/// <summary>
		/// users_role_key_fkey_BackReference
		/// </summary>
		[Association(ThisKey="RoleKey", OtherKey="RoleKey", CanBeNull=true, Relationship=Relationship.OneToMany, IsBackReference=true)]
		public IEnumerable<User> Usersrolekeyfkeys { get; set; }

		#endregion
	}

	[Table(Schema="public", Name="stocks")]
	public partial class Stock
	{
		[Column("stock_id"),    PrimaryKey,  Identity] public int    StockId     { get; set; } // integer
		[Column("stock_name"),  NotNull              ] public string StockName   { get; set; } // character varying(40)
		[Column("description"),    Nullable          ] public string Description { get; set; } // character varying(250)
		[Column("markup"),         Nullable          ] public float? Markup      { get; set; } // real
		[Column("user_id"),        Nullable          ] public int?   UserId      { get; set; } // integer

		#region Associations

		/// <summary>
		/// expenditure_invoices_stock_id_fkey_BackReference
		/// </summary>
		[Association(ThisKey="StockId", OtherKey="StockId", CanBeNull=true, Relationship=Relationship.OneToMany, IsBackReference=true)]
		public IEnumerable<ExpenditureInvoice> Expenditureinvoicesstockidfkeys { get; set; }

		/// <summary>
		/// receipt_invoices_stock_id_fkey_BackReference
		/// </summary>
		[Association(ThisKey="StockId", OtherKey="StockId", CanBeNull=true, Relationship=Relationship.OneToMany, IsBackReference=true)]
		public IEnumerable<ReceiptInvoice> Receiptinvoicesstockidfkeys { get; set; }

		/// <summary>
		/// stocks_user_id_fkey
		/// </summary>
		[Association(ThisKey="UserId", OtherKey="UserId", CanBeNull=true, Relationship=Relationship.ManyToOne, KeyName="stocks_user_id_fkey", BackReferenceName="Stocksuseridfkeys")]
	...
	public partial class User
	{
		...
		[Column("role_key"),     Nullable          ] public string RoleKey  { get; set; } // character varying(15)
		[Column("user_name"), NotNull              ] public string UserName { get; set; } // character varying(40)
		[Column("user_pass"), NotNull              ] public string UserPass { get; set; } // character varying(40)
		[Column("full_name"),    Nullable          ] public string FullName { get; set; } // character varying(100)
		...
		/// users_role_key_fkey
		/// </summary>
		[Association(ThisKey="RoleKey", OtherKey="RoleKey", CanBeNull=true, Relationship=Relationship.ManyToOne, KeyName="users_role_key_fkey", BackReferenceName="Usersrolekeyfkeys")]
		public Role Rolekeyfkey { get; set; }

		/// <summary>
		/// stocks_user_id_fkey_BackReference
		/// </summary>
		[Association(ThisKey="UserId", OtherKey="UserId", CanBeNull=true, Relationship=Relationship.OneToMany, IsBackReference=true)]
		public IEnumerable<Stock> Stocksuseridfkeys { get; set; }
	...
	public static partial class TableExtensions
	{
		...
		public static ExpenditureInvoice Find(this ITable<ExpenditureInvoice> table, int ExpenditureInvoiceId)
		{
			return table.FirstOrDefault(t =>
				t.ExpenditureInvoiceId == ExpenditureInvoiceId);
		}
		...
		public static ReceiptInvoice Find(this ITable<ReceiptInvoice> table, int ReceiptInvoiceId)
		{
			return table.FirstOrDefault(t =>
				t.ReceiptInvoiceId == ReceiptInvoiceId);
		}

		public static Role Find(this ITable<Role> table, string RoleKey)
		{
			return table.FirstOrDefault(t =>
				t.RoleKey == RoleKey);
		}

		public static Stock Find(this ITable<Stock> table, int StockId)
		{
			return table.FirstOrDefault(t =>
				t.StockId == StockId);
		}
